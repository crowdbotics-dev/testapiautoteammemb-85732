...
## Project Structure
    ...
    ├── testapiautoteammemb_85732  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_85732`
...
2. Clone this repo and `cd testapiautoteammemb_85732`
